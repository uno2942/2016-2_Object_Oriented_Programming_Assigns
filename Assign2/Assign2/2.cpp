...
public:
	...
	VendingMachine(int& co_p, int& co_s, int& ci_p, int& ci_s, int& w_1, int& w_5) : remainder(0)
	{
	...
	void out()
	{
		cout << "coke: " << coke_s << " cider: " << cider_s << " 100: " << won_1 << " 500: " << won_5 << " remainder: " << remainder<<endl;
	}
	...
	void choose_item(bever t)
	{
		...
		catch (error e)
		{
			...
			{
				cout << "Shortage of coin"<<endl;
			}
			if (e == shortage_of_money)
				cout << "Shortage of money"<<endl;
			if (e == sold_out)
				cout << "Sold out"<<endl;
		}
	}
